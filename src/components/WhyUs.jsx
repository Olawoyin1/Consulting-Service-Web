  ...
  return (
    <div className="container2">
        ...
        <div className="comp-header text-center d-flex flex-column align-items-center justify-content-center my-4">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quidem fugiat illo similique qui repellendus maiores. Quae aspernatur officia numquam odit!</p>   
        </div>
      <div className="grid2 my-4 gap-4">
        {/* Left Side (First 3 Items) */}
        <div className="left d-flex flex-column gap-md-3 gap-4">
          {whyChooseUs.slice(0, 3).map((item) => (
            <div key={item.id} className="why">
              <div className="why-card  d-flex flex-column gap-3">
                <div className="why-card-image">
                  <img src={item.image} alt={item.name} />
                </div>
                <div className="why-card-content">
        ...
        <div className="middle d-none d-md-grid ">
